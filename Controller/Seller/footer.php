    ...
    <script src="../../assets/template/lib/datatables.net-dt/js/dataTables.dataTables.min.js"></script>
    <script src="../../assets/template/lib/datatables.net-responsive/js/dataTables.responsive.min.js"></script>
    <script src="../../assets/template/lib/datatables.net-responsive-dt/js/responsive.dataTables.min.js"></script>
